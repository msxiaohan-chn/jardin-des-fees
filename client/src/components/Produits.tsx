...
const produits: Product[] = [
  ...
  },
  {
    ...
    tag: null,
    images: [
      { url: "/manus-storage/CentreDeTable01_7cef9c24.jpg", aspectRatio: "1.5" },
      { url: "/manus-storage/CentreDeTable02_965c9afd.jpg", aspectRatio: "1.5" },
      { url: "/manus-storage/CentreDeTable03_f85b5723.jpg", aspectRatio: "0.56" },
    ],
    highlight: false,
  },
  {
    ...
    images: [
      ...
      { url: "/manus-storage/CompositionFlorale02_edc4df95.jpg", aspectRatio: "1.12" },
      { url: "/manus-storage/CompositionFlorale03_02127e1e.jpg", aspectRatio: "0.75" },
      { url: "/manus-storage/CompositionFlorale04_945f4795.jpg", aspectRatio: "1.33" },
    ],
    highlight: false,
  },
  {
